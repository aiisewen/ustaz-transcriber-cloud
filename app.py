...
5. Метки времени [1:30] в переводе не воспроизводи — пиши сплошным текстом.
...
8. Верни ТОЛЬКО перевод, без вступлений и комментариев.

Пример подхода:
- Дословно (плохо): «Это признак того, что такой человек несчастен, некоторые прежде говорили»
- По смыслу (хорошо): «Это признак несчастного человека — так говорили ещё старики»
